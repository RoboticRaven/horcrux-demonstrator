...
## 1. Description
This repository contains a demonstrator of the cryptographic authentication protocol known as 'horcrux-protocol'.
...
The projects can be roughly broken down as follows:
- the contents of the base folder:
...
Development took place on a virtual machine inside VMWare Workstation Pro using the (at the time of development) most recent version of Ubuntu LTS. It is recommended to do the same or use a comparable (*nix-like) setup.
